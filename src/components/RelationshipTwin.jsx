          ...
          <div className="bg-white border border-sand-200/90 rounded-2xl p-4 shadow-sm space-y-4">
            ...
            <div className="space-y-2">
              <h4 className="text-xs font-semibold tracking-wider text-sand-500 uppercase">
                Observations from check-ins
              </h4>
              <ul className="space-y-2.5">
                {currentSnapshot.observations && currentSnapshot.observations.map((obs, idx) => (
                  <li key={idx} className="flex items-start gap-2 text-xs text-sand-800 leading-relaxed">
            ...
            {/* Pattern Check (Green / Yellow / Red) */}
            {!safetyStatus.isTriggered && (
              <div className="border-t border-sand-100 pt-4">
                <PatternCheck
                  patterns={currentSnapshot.patterns}
                  reflectionQuestion={currentSnapshot.reflectionQuestion}
