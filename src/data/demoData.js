...
export const DEMO_CHECKINS = [
  ...
  },
  {
    ...
    createdAt: '2026-10-18T22:00:00Z'
  },
  {
    id: 'demo-checkin-3',
    contactId: DEMO_CONTACT_ID,
    ...
    createdAt: '2026-10-26T21:45:00Z'
  },
  {
    id: 'demo-checkin-4',
    contactId: DEMO_CONTACT_ID,
    ...
    createdAt: '2026-11-04T20:15:00Z'
  },
  {
    id: 'demo-checkin-5',
    contactId: DEMO_CONTACT_ID,
    ...
    createdAt: '2026-11-14T23:50:00Z'
  },
  {
    id: 'demo-checkin-6',
    contactId: DEMO_CONTACT_ID,
    ...
    createdAt: '2026-12-05T15:20:00Z'
  }
];
...
export const DEMO_TWIN_SNAPSHOTS = [
  {
    ...
    observations: [
      'Showed active listening and asked thoughtful questions without interrupting. [Check-in: Oct 10]',
      'Retained specific details from earlier conversations. [Check-in: Oct 10]',
      'Maintained predictable, considerate messaging beforehand. [Check-in: Oct 10]'
    ],
    whatChanged: 'Initial baseline established: Respectful, paced interest with mutual curiosity.',
    patterns: {
      green: [
        'Active listening and punctual communication can be a sign of genuine interest and respect for personal boundaries. [Check-in: Oct 10]'
      ],
      yellow: [],
      red: []
    },
  ...
  },
  {
    ...
    observations: [
      'Proactively proposed and reserved plans around your mutual interests. [Check-in: Oct 18]',
      'Frequent, enthusiastic messaging from morning to evening. [Check-in: Oct 18]',
      'Expressed appreciation for your perspective and values. [Check-in: Oct 18]'
    ],
    whatChanged: 'Communication frequency and proactive initiative increased noticeably compared to Week 1.',
    patterns: {
      green: [
        'Planning thoughtful dates in advance can be a sign of intentionality and consideration. [Check-in: Oct 18]'
      ],
      yellow: [
        'A steep acceleration in messaging frequency early on can be a sign of rapid emotional projection before deep familiarity exists. [Check-in: Oct 18]'
      ],
      red: []
    },
  ...
  },
  {
    ...
    observations: [
      'High level of attention, daily calls, and constant availability. [Check-in: Oct 26]',
      'Expressed intense declarations of a unique, instant bond. [Check-in: Oct 26]',
      'Strong romantic framing with generous verbal affirmation. [Check-in: Oct 26]'
    ],
    whatChanged: 'Shifted from balanced mutual curiosity into intense romantic acceleration and high declarations.',
    patterns: {
      green: [
        'Warm emotional availability can be a sign of openness and romantic affection. [Check-in: Oct 26]'
      ],
      yellow: [
        'Declaring an unprecedented connection within three weeks can be a sign of romantic idealization rather than seeing you as a real, nuanced person. [Check-in: Oct 26]'
      ],
      red: []
    },
  ...
  },
  {
    ...
    observations: [
      'Cancelled a scheduled date on 45 minutes notice with a vague explanation. [Check-in: Nov 04]',
      'Followed cancellation with 24 hours of silence and terse one-word replies. [Check-in: Nov 04]',
      'Left you in the position of initiating to check on the status of plans. [Check-in: Nov 04]'
    ],
    ...
    patterns: {
      green: [],
      yellow: [
        'Last-minute cancellations without offering an alternative date can be a sign of fluctuating priority or poor consideration. [Check-in: Nov 04]'
      ],
      red: [
        'A sudden shift from daily adoration to prolonged silence and cold responses can be a sign of hot-and-cold relational dynamics. [Check-in: Nov 04]'
      ]
    },
  ...
  },
  {
    ...
    observations: [
      'Silence broken only late at night (11:30 PM) for a personal work favor. [Check-in: Nov 14]',
      'Did not acknowledge the previously cancelled date or the 5 days of silence. [Check-in: Nov 14]',
      'Slow response times resumed as soon as your emotional needs or plans were mentioned. [Check-in: Nov 14]'
    ],
    ...
    patterns: {
      green: [],
      yellow: [
        'Reaching out late at night primarily when seeking assistance can be a sign of viewing the relationship through convenience. [Check-in: Nov 14]'
      ],
      red: [
        'Ignoring past cancellations while expecting immediate availability for favors can be a sign of entitlement and unequal emotional investment. [Check-in: Nov 14]'
      ]
    },
  ...
  },
  {
    ...
    observations: [
      'Dismissed honest communication about inconsistency by labeling it "dramatic and demanding". [Check-in: Dec 05]',
      'Cycle confirmed across 8 weeks: high praise followed by withdrawal and deflection when held accountable. [Check-in: Oct 26, Nov 04, Dec 05]',
      'Displays reluctance to invest equal time and emotional consideration. [Check-in: Nov 14, Dec 05]'
    ],
    ...
    patterns: {
      green: [],
      yellow: [
        'Defensiveness during calm relationship check-ins can be a sign of limited emotional maturity or discomfort with self-reflection. [Check-in: Dec 05]'
      ],
      red: [
        'Calling you "dramatic" or "demanding" when you articulate reasonable consistency can be a sign of emotional invalidation and tone policing. [Check-in: Dec 05]',
        'A repeating cycle of intense pursuit followed by cold withdrawal and blame can be a sign of intermittent reinforcement and emotional manipulation. [Check-in: Oct 26, Nov 04, Dec 05]'
      ]
    },
